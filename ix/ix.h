...
class IndexManager {
 public:
  ...
  bool fallsRange(BtreeNode *node, void *key, const void *lowKey, const void *highKey, bool lowKeyInclusive, bool highKeyInclusive);
...
class IX_ScanIterator {
 public:
  ...
  IX_ScanIterator(AttrType &attrType);
  RC getNextEntry(RID &rid, void *key);     // Get next matching entry
  RC close();                         // Terminate index scan

  void addRID(RID &rid) { rids.push_back(rid); };
  void addKey(void *key);
  void resetState();
